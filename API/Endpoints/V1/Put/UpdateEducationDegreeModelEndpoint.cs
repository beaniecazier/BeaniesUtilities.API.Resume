...
public class UpdateEducationDegreeModelEndpoint : IEndpoints
{
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app.MapPut($"{EndpointPrefix}/{{id}}", UpdateEducationDegreeModelAsync)
            .WithName("UpdateEducationDegreeModel")
            .Accepts<EducationDegreeModel>(ContentType)
            .Produces<EducationDegreeModel>(StatusCodes.Status200OK)
    ...
    private static async Task<IResult> UpdateEducationDegreeModelAsync(UpdateEducationDegreeModelRequest changes,
        IEducationDegreeModelService service, IEducationInstitutionModelService educationInstitutionService,

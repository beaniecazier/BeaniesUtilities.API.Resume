...
public class UpdateEducationInstitutionModelEndpoint : IEndpoints
{
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app.MapPut(EducationInstitutionModelEndpoints.Put, UpdateEducationInstitutionModelAsync)
            .WithName("UpdateEducationInstitutionModel")
            .Accepts<UpdateEducationInstitutionModelRequest>(ContentType)
        ...
        //var multipleEndpoint = app.MapPut(EducationInstitutionModelEndpoints.EndpointPrefix, PutModelCollectionAsync)
    ...
    private static async Task<IResult> UpdateEducationInstitutionModelAsync(int id, UpdateEducationInstitutionModelRequest changes,
        ...
        IOutputCacheStore outputCacheStore, LinkGenerator linker, HttpContext http, CancellationToken token)
    {
        ...
        var newModel = changes.MapToModelFromUpdateRequest((EducationInstitutionModel)oldModel!, username, (AddressModel)requestedAddressModel);
        ...
        if (!result.IsFail) await outputCacheStore.EvictByTagAsync(EducationInstitutionModelEndpoints.Tag, token);
        return result.Match(
            Succ =>
            {

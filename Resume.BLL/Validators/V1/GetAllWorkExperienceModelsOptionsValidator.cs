...
public class GetAllWorkExperienceModelsOptionsValidator : AbstractValidator<GetAllWorkExperienceModelsOptions>
{
    ...
    public GetAllWorkExperienceModelsOptionsValidator()
    {

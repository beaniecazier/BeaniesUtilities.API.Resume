...
public class GetAllEducationInstitutionModelsOptionsValidator : AbstractValidator<GetAllEducationInstitutionModelsOptions>
{
    public GetAllEducationInstitutionModelsOptionsValidator()
    {

...
public class EducationDegreeEndpoints : IEndpoints
{
    ...
    {
        // Create Endpoints
        app.MapPost(BaseRoute, CreateEducationDegreeModelAsync)
            .WithName("CreateEducationDegree")
            .Accepts<EditibleEducationDegreeModel>(ContentType)
            .Produces<EducationDegreeModel>(201)
            .Produces<IEnumerable<ValidationFailure>>(400)
            .WithTags(Tag);

        // Read Endpoints
        app.MapGet(BaseRoute, GetAllEducationDegreeModelsAsync)
            .WithName("GetAllEducationDegreeModels")
            .Produces(200)
            .WithTags(Tag);

        app.MapGet($"{BaseRoute}/{{id}}", GetEducationDegreeModelByIDAsync)
        ...
        app.MapGet($"{BaseRoute}/entry{{entryId}}", GetEducationDegreeModelByEntryIDAsync)
            .WithName("GetEducationDegreeModelByEntryID")
            .Produces(200)
            .Produces<IEnumerable<ValidationFailure>>(400)      // you gave bad info
            .Produces(404)                                      // could not find entry to update
            .WithTags(Tag);

        //app.MapGet($"{BaseRoute}/history{{id}}", GetHistroyOfEducationDegreeModelByIDAsync)
        //    .WithName("GetHistroyOfEducationDegreeModelByID")
        //    .WithTags(Tag);

        // Update Endpoints
        app.MapPut($"{BaseRoute}/{{id}}", UpdateEducationDegreeModelAsync)
            .WithName("UpdateEducationDegreeModel")
            .Accepts<EditibleEducationDegreeModel>(ContentType)
            .Produces<EducationDegreeModel>(200)
            .Produces<IEnumerable<ValidationFailure>>(400)      // you gave bad info
            .Produces(404)                                      // could not find entry to update
            .WithTags(Tag);
    ...
    /// </summary>
    /// <param name="newEntry">The parameters used to make the new EducationDegree Model</param>
    /// <param name="service">The service class the serves this endpoint for database operations</param>
    /// <param name="vaildator">EducationDegree Model value validator</param>
    ...
    private static async Task<IResult> CreateEducationDegreeModelAsync(EditibleEducationDegreeModel newEntry,
        IEducationDegreeService service, IValidator<EditibleEducationDegreeModel> vaildator,
        LinkGenerator linker, HttpContext http, ResumeContext ctx)
    {
        ...
        //{
        //    new ("ID", "This EducationDegree already exists in the database." ),
        //});
        return created.Match(
            succ =>
            {
                var locationUri = linker.GetUriByName(http, "GetEducationDegreeModel", new { id = succ.CommonIdentity });
    ...
    private static async Task<IResult> GetAllEducationDegreeModelsAsync(IEducationDegreeService service, ResumeContext ctx, string? nameSearchTerm,
    ...
    /// <response code="400">Something went wrong or the database does not exist</response>
    /// <response code="404">If the id is not found in the database</response>
    private static async Task<IResult> GetEducationDegreeModelByIDAsync(int id, IEducationDegreeService service, ResumeContext ctx)
    {
    ...
    /// <response code="400">Something went wrong or the database does not exist</response>
    /// <response code="404">If the id is not found in the database</response>
    private static async Task<IResult> GetEducationDegreeModelByEntryIDAsync(int entryId,IEducationDegreeService service, ResumeContext ctx)
    {
    ...
    //private static async Task<IResult> GetHistroyOfEducationDegreeModelByIDAsync(int id, IEducationDegreeService service, ResumeContext ctx)
    //{
    ...
    /// <summary>
    /// Search for and remove a specific EducationDegree Model entry from the database
    /// </summary>
    /// <param name="id">TODO</param>
    ...
    /// <response code="400">Something went wrong or the database does not exist</response>
    /// <response code="404">If the id is not found in the database</response>
    private static async Task<IResult> UpdateEducationDegreeModelAsync(int id, EditibleEducationDegreeModel changes,
        IEducationDegreeService service, IValidator<EditibleEducationDegreeModel> vaildator, ResumeContext ctx)
    {
    ...
    /// <response code="400">Something went wrong or the database does not exist</response>
    /// <response code="404">If the id is not found in the database</response>
    private static async Task<IResult> DeleteAsync(int id, IEducationDegreeService service, ResumeContext ctx)
    {
    ...
    /// <response code="400">Something went wrong or the database does not exist</response>
    /// <response code="404">If the id is not found in the database</response>
    private static async Task<IResult> DeleteEntryAsync(int id, IEducationDegreeService service, ResumeContext ctx)
    {

...
public class PersonEndpoints : IEndpoints
{
    ...
    {
        services.AddSingleton<IPersonService, PersonModelService>();
    }

    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        app.MapPost(BaseRoute, CreatePersonModelModel);
    }

    private static async Task<IResult> CreatePersonModelModel(EditiblePersonModel newEntry, IPersonService service, IValidator<EditiblePersonModel> vaildator)
    {

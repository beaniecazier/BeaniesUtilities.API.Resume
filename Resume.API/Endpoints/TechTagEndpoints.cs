...
public class TechTagEndpoints : IEndpoints
{
    ...
    private const string BaseRoute = "tech-tags";
    ...
    {
        app.MapPost(BaseRoute, CreateTechTagModel);
    }

    private static async Task<IResult> CreateTechTagModel(EditibleTechTagModel newEntry, ITechTagService service, IValidator<EditibleTechTagModel> vaildator)
    {

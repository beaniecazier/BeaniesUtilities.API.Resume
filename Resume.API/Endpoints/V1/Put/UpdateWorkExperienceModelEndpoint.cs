...
public class UpdateWorkExperienceModelEndpoint : IEndpoints
{
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app.MapPut($"{EndpointPrefix}/{{id}}", UpdateWorkExperienceModelAsync)
            .WithName("UpdateWorkExperienceModel")
            .Accepts<WorkExperienceModel>(ContentType)
            .Produces<WorkExperienceModel>(StatusCodes.Status200OK)
    ...
    private static async Task<IResult> UpdateWorkExperienceModelAsync(UpdateWorkExperienceModelRequest changes,
        IWorkExperienceModelService service, ITechTagModelService techTagService, LinkGenerator linker, HttpContext http, CancellationToken token)
    {
        ...
        var newModel = changes.MapToModelFromUpdateRequest((WorkExperienceModel)oldModel!, username, (List<TechTagModel>)requestedTechTagModels);

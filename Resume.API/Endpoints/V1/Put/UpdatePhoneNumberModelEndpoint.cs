...
public class UpdatePhoneNumberModelEndpoint : IEndpoints
{
    ...
    private static async Task<IResult> UpdatePhoneNumberModelAsync(UpdatePhoneNumberModelRequest changes,
        IPhoneNumberModelService service, LinkGenerator linker, HttpContext http, CancellationToken token)
    {
        ...
        var newModel = changes.MapToModelFromUpdateRequest((PhoneNumberModel)oldModel!, username);

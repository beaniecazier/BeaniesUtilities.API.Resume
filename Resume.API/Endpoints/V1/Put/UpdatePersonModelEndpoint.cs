...
public class UpdatePersonModelEndpoint : IEndpoints
{
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app.MapPut($"{EndpointPrefix}/{{id}}", UpdatePersonModelAsync)
            .WithName("UpdatePersonModel")
            .Accepts<PersonModel>(ContentType)
            .Produces<PersonModel>(StatusCodes.Status200OK)
    ...
    private static async Task<IResult> UpdatePersonModelAsync(UpdatePersonModelRequest changes,

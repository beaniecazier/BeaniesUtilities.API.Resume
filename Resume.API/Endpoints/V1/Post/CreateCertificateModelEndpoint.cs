...
public class CreateCertificateModelEndpoint : IEndpoints
{
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app.MapPost(EndpointPrefix, CreateCertificateModelAsync)
    ...
    private static async Task<IResult> CreateCertificateModelAsync(CreateCertificateModelRequest request,
        ICertificateModelService service, IEducationInstitutionModelService educationInstitutionService, LinkGenerator linker, HttpContext http, CancellationToken token)
    {
        ...
        var requestedEducationInstitutionModel = await educationInstitutionService.GetByIDAsync(request.Issuer, token);

...
public class CreateAddressModelEndpoint : IEndpoints
{
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app.MapPost(EndpointPrefix, CreateAddressModelAsync)
    ...
    private static async Task<IResult> CreateAddressModelAsync(CreateAddressModelRequest request,
        IAddressModelService service, LinkGenerator linker, HttpContext http, CancellationToken token)
    {

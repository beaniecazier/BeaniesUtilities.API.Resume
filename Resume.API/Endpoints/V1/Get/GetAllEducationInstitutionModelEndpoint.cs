...
/// </summary>
[ApiVersion(1.0)]
public class GetAllEducationInstitutionModelEndpoint : IEndpoints
{
    ...
    {
        Log.Information("Now adding EducationInstitution Model get endpoints");
        var singleEndpoint = app.MapGet(EndpointPrefix, GetAllEducationInstitutionModelsAsync)

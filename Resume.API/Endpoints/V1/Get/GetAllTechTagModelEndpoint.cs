...
/// </summary>
[ApiVersion(1.0)]
public class GetAllTechTagModelEndpoint : IEndpoints
{
    ...
    {
        Log.Information("Now adding TechTag Model get endpoints");
        var singleEndpoint = app.MapGet(EndpointPrefix, GetAllTechTagModelsAsync)

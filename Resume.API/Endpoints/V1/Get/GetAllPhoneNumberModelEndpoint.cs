...
/// </summary>
[ApiVersion(1.0)]
public class GetAllPhoneNumberModelEndpoint : IEndpoints
{
    ...
    {
        Log.Information("Now adding PhoneNumber Model get endpoints");
        var singleEndpoint = app.MapGet(EndpointPrefix, GetAllPhoneNumberModelsAsync)

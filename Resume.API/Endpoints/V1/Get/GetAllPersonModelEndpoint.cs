...
/// </summary>
[ApiVersion(1.0)]
public class GetAllPersonModelEndpoint : IEndpoints
{
    ...
    {
        Log.Information("Now adding Person Model get endpoints");
        var singleEndpoint = app.MapGet(EndpointPrefix, GetAllPersonModelsAsync)

...
/// </summary>
[ApiVersion(1.0)]
public class GetAllProjectModelEndpoint : IEndpoints
{
    ...
    {
        Log.Information("Now adding Project Model get endpoints");
        var singleEndpoint = app.MapGet(EndpointPrefix, GetAllProjectModelsAsync)
